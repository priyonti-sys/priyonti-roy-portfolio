...
3. Navigation opens About, Experience, Projects, Education, and Contact as separate pages in the same tab.

EDITING
- Edit shared navigation, footer, or page copy in site-template.html, then run: python build_pages.py
- Edit experience, projects, achievements, and interactive behavior in script.js.
...
- Experience tabs, searchable project cards and details, and achievement carousel
